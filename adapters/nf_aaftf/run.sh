...
OUT_FASTA="${ASSEMBLY_OUT}/${DATASET_ID}_nf_aaftf.fasta.gz"
gzip -c "${SORTED_FASTA}" > "${OUT_FASTA}"
...
OUTPUTS_JSON='[{"path": "assembly/'${DATASET_ID}'_nf_aaftf.fasta.gz", "md5": "'${MD5}'", "size": '${SIZE}'}]'
TRUTH_ACCESSION="none"
finalize "success"
